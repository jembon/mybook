...
| | Cold Contact | Warm Contact | Hot Contact |
|---|---|---|---|
| **Start with** | Safe topic | Probe topic | Depth topic |
| **Move to** | Probe (if they engage) | Depth (if they're open) | Depth (continue) |
| **Goal** | Open the channel | Gather intelligence | Deepen or deliver value |
| **Exit after** | 2-3 minutes | 5-7 minutes | As long as productive |
| **Follow-up** | "Good to meet you" + connect online | Reference this conversation next time | Act on what you discussed |
