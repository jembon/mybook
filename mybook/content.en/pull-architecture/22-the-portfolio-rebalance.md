...
| Quarter | Month | Focus | Duration | Key Output |
|---------|-------|-------|----------|------------|
| Q1 | January | Core Review (Ring 1-2) | 90 min | Promotion/adjustment list |
| Q2 | April | Expansion Review (Ring 3-4) | 90 min | Target/release list |
| Q3 | July | Diversity Check (Ring 5-6) | 90 min | New input sources |
| Q4 | October | Full System Review (All rings) | 120 min | Comprehensive plan |
