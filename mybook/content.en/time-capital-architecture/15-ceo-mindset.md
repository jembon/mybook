...
|-------|-------------|---------|
| **Hourly** | Time for money, directly | Consulting, freelancing |
| **Project** | Fixed fee for defined outcomes | Contract work, deliverables |
| **Retainer** | Recurring revenue for ongoing access | Advisory roles, maintenance |
| **Product** | Create once, sell repeatedly | Courses, templates, books |
| **Equity** | Own a share of value you help create | Partnerships, investments |
