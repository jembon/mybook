...
A millionaire with no sense of purpose? Recognition × 0 × Achievement = **zero**.
A passionate artist who never ships work? Recognition × Fulfillment × 0 = **zero**.
A brilliant introvert nobody knows? 0 × Fulfillment × Achievement = **zero**.
