...
1. **Conscious application.** You know the rule. You think about it. You apply it deliberately. Slow and clunky. Every decision costs mental effort.

2. **Pattern clustering.** After enough reps, individual rules start grouping into larger chunks. You stop thinking about single moves and start thinking about sequences. The cook stops measuring flour and starts recognizing "that looks right." The chess player stops calculating individual piece movements and starts seeing "this structure is weak."

3. **Automatic response.** The patterns become so deeply embedded that you respond before conscious thought kicks in. The driver brakes before registering the obstacle. The musician's fingers adjust before hearing the wrong note. The programmer spots the bug before reading the error message.
