---
title: "Ch4 02: Five Poses, One Practice"
...
1. **It uses only core elements.** Nothing extra. Nothing advanced. Nothing "nice to have."
2. **It fits in 15-20 minutes.** Short enough to do every day. Short enough that you never have a good excuse to skip it.
3. **It's repeatable.** The same basic structure, day after day, with minor variations as you improve.
...
1. Four chords: C, G, Am, F (these four cover dozens of popular songs)
2. One strumming pattern: down-down-up-up-down-up
3. Chord transitions between these four chords
4. Singing while strumming (coordination)
...
1. **Your current elements feel automatic.** You don't have to think about them. They just happen. For a physical skill, the movement is smooth without conscious attention. For a cognitive skill, the concept is available without effort.

2. **You've hit a ceiling.** Your core set can't handle something you want to do. You want to play a song that requires a new chord. You want to cook a dish that requires a new technique. The need comes from practice, not from a textbook.

3. **You're bored — productively.** Not the kind of boredom that means you should quit. The kind that means you've outgrown the current challenge. Your brain is ready for more.
