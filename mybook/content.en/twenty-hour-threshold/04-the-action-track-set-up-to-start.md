---
title: "Ch2 01: The Action Track: Set Up to Start"
slug: "the-action-track-set-up-to-start"
weight: 4
translationKey: book-twenty-hour-threshold-ch04
draft: false
---
...
1. **One skill** selected (want, not should)
2. **One target** defined (testable, not vague)
3. **Core sub-skills** identified (3-5 priorities, ordered by dependency)
4. **Environment** prepared (tools ready, space set, distractions removed)
5. **Schedule** committed (specific time, protected, with a startup ritual)
